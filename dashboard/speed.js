...
var SpeedComponent = (function () {
    function SpeedComponent(div) {
        this.div = div;
        this.arealinegraphs = [];
    }
    SpeedComponent.prototype.createAreaLineGraph = function (name, label, min, max) {
        var config = {
            size: 120,
            label: label,
        };
    ...
    SpeedComponent.prototype.createAreaLineGraphs = function () {
        this.createAreaLineGraph("speed", "Speed");
    };
    SpeedComponent.prototype.updateAreaLineGraphs = function () {
    };
    SpeedComponent.prototype.initialize = function () {
        this.createAreaLineGraphs();
        setInterval(this.updateAreaLineGraphs, 5000);
    };
    SpeedComponent.prototype.ngAfterViewInit = function () {
        this.initialize();
    };
